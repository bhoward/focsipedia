...
Read about [nondeterministic finite-state automata](/docs/lang/nfa) and their [connection to regular expressions](/docs/lang/fsareg), and try the exercises in those sections.
