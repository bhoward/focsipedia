...
that $L$ is not a regular language.[^ TODO] However, it is a context-free
...
5. Find a context-free grammar that generates the language
$\{w\in\{a,b\}^*\;|\; n_a(w) > n_b(w)\}$.

6. Find a context-free grammar that generates the language
$\{w\in\{a,b,c\}^*\;|\; n_a(w) = n_b(w)\}$.

7. A **palindrome** is a string that reads the same
...
9. Define a **left-regular grammar**
